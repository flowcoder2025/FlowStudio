...
const INDUSTRY_KEYWORDS: Record<Industry, string[]> = {
  ...
  "photo-studio": [
    "사진관", "증명사진", "프로필사진", "프로필", "여권사진", "운전면허", "비자사진",
    "이력서사진", "취업사진", "링크드인", "LinkedIn", "명함사진", "헤드샷",
    "보정", "리터칭", "피부보정", "얼굴보정", "누끼", "배경제거", "배경교체",
    "단체사진", "가족사진", "합성", "퍼스널컬러", "인물사진", "셀프사진관",
    "SNS프로필", "인스타프로필", "비즈니스프로필", "전문가사진", "반명함",
  ],
};
...
const EXPRESSION_KEYWORDS: Record<ExpressionIntent, string[]> = {
  ...
  // 인물 사진 (AI 사진관)
  "portrait.id-photo": [
    "증명사진", "여권사진", "운전면허", "주민등록", "비자사진", "학생증", "반명함",
    "여권", "면허증", "신분증", "공무원증", "의사", "간호사", "자격증",
  ],
  "portrait.business-profile": [
    "비즈니스프로필", "링크드인", "LinkedIn", "명함사진", "헤드샷", "전문가",
    "기업프로필", "회사홈페이지", "임원사진", "대표사진", "프로필촬영",
  ],
  "portrait.sns-profile": [
    "SNS프로필", "인스타프로필", "카카오프로필", "페이스북", "소셜미디어",
    "인스타그램", "카카오톡", "프사", "프로필사진",
  ],
  "portrait.job-application": [
    "취업사진", "이력서사진", "입사지원", "취준", "취업용", "면접사진",
    "자기소개서", "채용", "지원서사진",
  ],
  "portrait.beauty-retouch": [
    "피부보정", "얼굴보정", "체형보정", "갸름하게", "리터칭", "뷰티보정",
    "피부톤", "잡티제거", "주름보정", "다리길게", "얼굴작게",
  ],
  "portrait.background-change": [
    "배경교체", "배경제거", "누끼", "배경합성", "흰배경", "그레이배경",
    "배경따기", "배경바꾸기", "투명배경",
  ],
  "portrait.group-composite": [
    "단체사진합성", "인물추가", "인물제거", "가족사진합성", "합성사진",
    "단체사진", "졸업사진", "돌잔치합성",
  ],
  "portrait.personal-color": [
    "퍼스널컬러", "웜톤", "쿨톤", "색진단", "컬러진단", "톤앤매너",
    "봄웜", "여름쿨", "가을웜", "겨울쿨",
  ],
};
