      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-8">
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 mb-2">
            {isKorean ? 'FlowStudio 서비스 이용약관' : 'FlowStudio Terms of Service'}
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mb-8">
            {isKorean ? '시행일: 2026년 1월 1일' : 'Effective: January 1, 2026'}
          </p>
...
function Chapter({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-10">
      <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-6 pb-2 border-b-2 border-indigo-500">
        {title}
      </h2>
      {children}
    </div>
    ...
    <>
      <Chapter title="Chapter 1. General Provisions">
        <Section title="Article 1 (Purpose)">
          <p>
            These Terms govern the rights, obligations, and responsibilities of FlowCoder (&quot;Company&quot;) and users
            in using the FlowStudio service (&quot;Service&quot;).
          </p>
        </Section>
        ...
        <Section title="Article 2 (Definitions)">
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li><strong>&quot;User&quot;</strong> means members and non-members who use the Service under these Terms.</li>
            <li><strong>&quot;Member&quot;</strong> means a person who has registered for the Service and received a user ID.</li>
            ...
            <li><strong>&quot;AI Label&quot;</strong> means watermarks, metadata, or other identification marks attached to AI outputs pursuant to the Framework Act on AI Development and Trust Foundation.</li>
          </ol>
        </Section>

        <Section title="Article 3 (Effect and Amendment of Terms)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>These Terms take effect when posted on the Service screen or announced through other methods.</li>
            <li>The Company may amend these Terms as necessary within the scope that does not violate relevant laws.</li>
            <li>When amending the Terms, the Company will announce the effective date and reason for the change at least 7 days before the effective date. However, changes unfavorable to users will be announced at least 30 days in advance.</li>
            <li>Users who do not agree to the amended Terms may discontinue use and withdraw from the Service.</li>
          </ol>
        </Section>
      </Chapter>

      <Chapter title="Chapter 2. Service Agreement">
        <Section title="Article 4 (Establishment of Agreement)">
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>The Company may refuse or defer acceptance in the following cases:
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>Not using real name or using another person&apos;s identity</li>
                <li>Providing false information or not providing required information</li>
                <li>Being under 14 years of age</li>
                <li>Having previously lost membership status</li>
              </ul>
            </li>
          </ol>
        </Section>

        <Section title="Article 5 (Change of User Information)">
          <p>Members may view and modify their personal information at any time through the profile management page.</p>
        </Section>

        <Section title="Article 6 (Termination of Agreement)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Members may request withdrawal at any time through the withdrawal function within the Service.</li>
            <li>The Company may terminate the agreement without prior notice in the following cases:
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>Violating relevant laws or these Terms</li>
              </ul>
            </li>
          </ol>
        </Section>
      ...
      <Chapter title="Chapter 3. Obligations of Parties">
        <Section title="Article 7 (Company Obligations)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>The Company shall not engage in acts prohibited by relevant laws, these Terms, or public morals, and shall strive to provide continuous and stable services.</li>
            <li>The Company shall protect users&apos; personal information and disclose and comply with its privacy policy.</li>
            <li>The Company shall process opinions or complaints raised by users through appropriate procedures when deemed legitimate.</li>
          </ol>
        </Section>

        <Section title="Article 8 (User Obligations)">
          ...
          <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <li>Infringing intellectual property rights of the Company or third parties</li>
            <li>Damaging the reputation of or interfering with the business of the Company or third parties</li>
      ...
      <Chapter title="Chapter 4. Service Use">
        ...
        <Section title="Article 10 (Service Changes and Suspension)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>The Company may change all or part of the Service as necessary for operational or technical reasons.</li>
            <li>Changes to service content, usage methods, or usage times will be announced at least 7 days before the change, including the reason for change, changed service content, and provision date.</li>
          </ol>
        </Section>

        <Section title="Article 11 (Advertising and Marketing)">
          <div className="bg-indigo-50 dark:bg-indigo-900/30 p-4 rounded-lg border border-indigo-200 dark:border-indigo-700">
            <p className="font-medium mb-2">Marketing Information Consent</p>
            <p>The Company may conduct the following marketing activities in connection with service provision:</p>
          </div>
          <ul className="list-disc pl-6 space-y-2 mt-4">
            <li>May send promotional information including service information, events, and promotions to user email addresses.</li>
            <li>May use user-generated content (images) for service promotion, marketing, and portfolio purposes. Personal identifying information will be removed.</li>
            <li>Users may withdraw consent to marketing communications at any time.</li>
          </ul>
        </Section>
      </Chapter>
      ...
      <Chapter title="Chapter 5. Credits and Payment">
        <Section title="Article 12 (Credits)">
          <ol className="list-decimal pl-6 space-y-2">
            ...
            <li>Credits can be obtained through paid purchase or bonuses provided by the Company.</li>
            <li>Bonus credits must be used within 30 days of issuance and expire after this period.</li>
        ...
        <Section title="Article 13 (Payment)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Credits may be purchased using payment methods provided by the Company.</li>
            <li>Payment details are subject to a separate refund policy.</li>
          </ol>
        </Section>
      </Chapter>

      <Chapter title="Chapter 6. Copyright and Content">
        <Section title="Article 14 (Copyright Ownership)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Copyrights and intellectual property rights for the Service belong to the Company.</li>
            <li>Copyrights for content generated by users through the Service belong to the users.</li>
        ...
        <Section title="Article 15 (User-Generated Content)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Users have the right to freely use, modify, and distribute their generated content.</li>
            <li>Users must ensure their generated content does not infringe on others&apos; copyrights.</li>
            <li>The Company may delete illegal or inappropriate content and restrict service use.</li>
          </ol>
        </Section>
      </Chapter>
      ...
      <Chapter title="Chapter 7. Damages">
        <Section title="Article 16 (Limitation of Liability)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>The Company is exempt from liability when unable to provide services due to force majeure such as natural disasters.</li>
            <li>The Company is not liable for service disruptions caused by user fault.</li>
            <li>The Company is not responsible for the reliability or accuracy of information obtained through the Service.</li>
          </ol>
        </Section>

        <Section title="Article 17 (Compensation for Damages)">
          <p>If the Company or a user violates these Terms and causes damage to the other party, they are liable for compensation.</p>
        </Section>
      </Chapter>

      <Chapter title="Chapter 8. Miscellaneous">
        <Section title="Article 18 (Personal Information Protection)">
          <p>The Company strives to protect users&apos; personal information as prescribed by relevant laws. The Company&apos;s privacy policy applies to the protection and use of personal information.</p>
        </Section>

        <Section title="Article 19 (Dispute Resolution)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Disputes between the Company and users shall be subject to the exclusive jurisdiction of the Uijeongbu District Court, Republic of Korea.</li>
            <li>Korean law shall apply to lawsuits filed between the Company and users.</li>
          </ol>
        </Section>
      </Chapter>

      <Chapter title="Chapter 9. AI Outputs and Legal Compliance">
        <Section title="Article 20 (Characteristics and Labeling of AI Outputs)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>All content generated through this Service is AI output generated by artificial intelligence technology.</li>
            <li>The Company may apply the following labels to AI outputs pursuant to Article 31 of the Framework Act on AI Development and Trust Foundation:
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>Watermarks or visual identification marks</li>
                <li>Embedded metadata</li>
                <li>Other labeling methods prescribed by presidential decree</li>
              </ul>
            </li>
            <li>Users shall not arbitrarily remove, alter, or damage AI labels applied by the Company.</li>
            <li>Distribution of content with removed AI labels and resulting legal liability are solely the responsibility of the user.</li>
          </ol>
        </Section>

        <Section title="Article 21 (Copyright and User Responsibility for AI Outputs)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>AI outputs may not be subject to copyright protection under current copyright law in the absence of human creative contribution. Users understand this legal characteristic when using the Service.</li>
            <li>Users are responsible for legal compliance when using AI outputs commercially or non-commercially.</li>
            <li>Users must comply with the following when using AI outputs:
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>Compliance with labeling obligations under the Framework Act on AI and related laws</li>
                <li>Prohibition of infringing third-party intellectual property rights</li>
                <li>Prohibition of use for spreading false information or causing social confusion</li>
                <li>Prohibition of infringing others&apos; personality rights including portrait and reputation rights</li>
              </ul>
            </li>
          </ol>
        </Section>
        ...
        <Section title="Article 22 (Disclaimer for AI Outputs)">
          <ol className="list-decimal pl-6 space-y-2">
            <li>Due to the nature of AI technology, the Company does not guarantee the quality, accuracy, or suitability of outputs, which may differ from user expectations.</li>
            <li>The Company is not liable for legal disputes arising from users removing or altering AI labels.</li>
            ...
            <li>If users violate laws or cause damage to third parties using AI outputs, all responsibility lies with the user.</li>
          </ol>
        </Section>
      </Chapter>
      ...
      <div className="bg-slate-100 dark:bg-slate-700 p-4 rounded-lg mt-8">
        ...
        <ol className="list-decimal pl-6 space-y-2 mt-2">
          <li>These Terms take effect on January 1, 2026.</li>
          <li>Provisions in Chapter 9 (AI Outputs and Legal Compliance) pursuant to the Framework Act on AI Development and Trust Foundation take effect on January 22, 2026, the effective date of that law.</li>
        </ol>
      </div>
    </>
  )
