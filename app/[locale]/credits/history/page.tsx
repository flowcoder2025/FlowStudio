  ...
  const getTransactionDisplay = (transaction: CreditTransaction) => {
    ...
    switch (transaction.type) {
      ...
      case 'REFERRAL':
        ...
        label = t('typeReferral');
        break;
      case 'GENERATION':
        icon = <BarChart3 className="w-4 h-4" />;
        colorClass = 'text-orange-600 dark:text-orange-400';
        bgClass = 'bg-orange-100 dark:bg-orange-900/30';
        label = t('typeGeneration');
        break;
      case 'UPSCALE':
        icon = <BarChart3 className="w-4 h-4" />;
        colorClass = 'text-orange-600 dark:text-orange-400';
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          {[
            ...
            { value: 'PURCHASE', label: t('filterPurchase') },
            { value: 'BONUS', label: t('filterBonus') },
            { value: 'REFERRAL', label: t('filterReferral') },
            { value: 'GENERATION', label: t('filterGeneration') },
            { value: 'UPSCALE', label: t('filterUpscale') },
          ].map((filter) => (
            <button
              key={filter.value}
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-slate-500 dark:text-slate-400">
                {typeFilter ? t('noResults') : t('noHistory')}
              </p>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-base font-bold ${
                      ...
                      {isPositive ? '+' : ''}{transaction.amount} {t('credits')}
                    </span>
                  </div>
                );
              })}
